...
|----------|-------------|
| `routes_od_matrix.sql` | Origin-destination routing matrix example (project root) |
| `isochrones_from_points.sql` | Isochrone generation from points (trade-area-analysis skill) |
